    ...
    public class Parser
    {
        ...
        bool ParseString(string srcString, SwitchForm[] switchForms)
        {
            ...
            while (pos < len)
            {
                ...
                {
                    int switchLen =
                        switchForms[switchIndex].IDString.Length;

                    if (switchLen <= maxLen || pos + switchLen > len)
                        continue;

                    if (String.Compare(
                        switchForms[switchIndex].IDString,
                        0,
                        srcString,
                        pos,
                        switchLen, true) == 0)
                    ...
                    case SwitchType.UnLimitedPostString:
                        {
                            ...
                            {
                                matchedSwitch.PostStrings.Add(
                                    srcString.Substring(pos));
        ...
        static bool ParseSubCharsCommand(
            int numForms,
